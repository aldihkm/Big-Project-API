...
def request = (RequestObject)findTestObject('Cilsy Big Project/Admin/Admin User Login')


response = WS.sendRequestAndVerify(findTestObject('Cilsy Big Project/Admin/Admin User Login'))
